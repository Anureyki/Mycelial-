...
| **Grow** | 9009 | Gardener | Tracks growth stages, logs readings, suggests nutrient adjustments; local vision on photos, cross-source synthesis (`assess_plant`), web-checked stage and environment targets, gamified training-data collection |
